/**
 * Single source of truth for public site copy (and server-side merge defaults).
 * Optional image fields: set to a full URL after uploading via Admin → Site content.
 */
const siteContent = {
  site: {
    name: 'Hakaru RSA',
